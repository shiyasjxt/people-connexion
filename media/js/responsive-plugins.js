...
(function($){
	...
	$.fn.convertNavigation = function(options)
	{
		...
		var dropDown = $("<select class='navigation visible-xs'></select>");
...
(function($){
	...
	{
		var dropDown = $("<select style='position:absolute;top:0;left:0;width:100%;height:100%;opacity:0;cursor:pointer;'></select>");
